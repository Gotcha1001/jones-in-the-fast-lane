...
import { initAudio, loadClickSound, loadHealingCentreMusic, playClickSound, playHealingCentreMusic, stopHealingCentreMusic } from '@/data/audioManager';
...
export default function HealingCentre() {
    ...
    // Helper function to handle both message and toast - same as in University component
    ...
    const handlePurchaseService = (service) => {
        if (player.cash >= service.price) {
            ...
            // Use the showMessage helper function for success message
            showMessage(`You received a ${service.name} for $${service.price}. Health +${service.health}, Happiness +${service.happiness}`);
        } else {
            // Use the showMessage helper function for error message
            showMessage("You don't have enough cash for that service.");
        }
    };
                        ...
                        {services.map((service, index) => (
                            <FeatureMotionWrapper index={index} key={index}>
                                <div
                                    ...
                                    onClick={withSound(() => handlePurchaseService(service))}
                                >
