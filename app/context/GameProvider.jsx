...
// function GameProvider({ children }) {
//     // Load state from localStorage on initial load if available
//     const loadedState = typeof window !== 'undefined'
//         ? JSON.parse(localStorage.getItem('jonesGameState')) || initialState
//         : initialState;

//     const [state, dispatch] = useReducer(gameReducer, loadedState);

//     // Save state to localStorage whenever it changes
//     useEffect(() => {
//         if (typeof window !== 'undefined') {
//             localStorage.setItem('jonesGameState', JSON.stringify(state));
//         }
//     }, [state]);
